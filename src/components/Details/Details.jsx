...
const Details = () => {
  ...
  const filteredNews = news.filter((n) => n.id === newsId.id);
  console.log(filteredNews);
  return (
    <div>
      <div>
        <h3 className="font-semibold mb-4 text-center lg:text-left">
          News Details
        </h3>
      </div>
      <div>
            ...
            >
              ...
              <div className="white-main-div px-4">
                ...
                <div className="my-4 text-xs border-b border-gray-300 pb-4">
                  <p className=" mb-2  text-gray-500">{news.details}</p>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <div className="view-div flex items-center gap-2">
                    <FaEye />
                    <h3 className="text-sm font-semibold">{news.total_view}</h3>
                  </div>
                </div>
              </div>
            </div>
